...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should update submission' do
    patch submission_url(@submission), params: { submission: { code: @submission.code, exercice_id: @submission.exercice_id, language_id: @submission.language_id, user_id: @submission.user_id } }
