...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { exercice_id: @test.exercice_id, input: @test.input, output: @test.output } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { exercice_id: @test.exercice_id, input: @test.input, output: @test.output } }
