...
class SubmissionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @submission.save
        format.html { redirect_to submission_ide_path(@submission.exercise_id, "results") }
  ...
  def run_tests_battery
    ...
    tests = @submission.exercise.tests_specification.tests.map { |test| [test.input, test.output] }
  ...
  def submission_params
    params.require(:submission).permit(:code, :user_id, :language_id, :exercise_id)
  end
end
